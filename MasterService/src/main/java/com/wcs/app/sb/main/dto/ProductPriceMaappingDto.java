...
public class ProductPriceMaappingDto 
{
	...
	public ProductPriceMaappingDto(String productname, String producthsncode, String producttype, String productcode,
			  String productcategoryname,float sellingprice, float taxgroup, String suppliername) {
